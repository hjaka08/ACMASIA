...
The attacker does not need to register their device with the OLT; thus, a receive only optical device can record the downstream stream without transmitting.
